...
print(dataset_walking['acc_phone_x'].min(), dataset_walking['acc_phone_y'].min(), dataset_walking['acc_phone_z'].min())
print(dataset_walking['acc_phone_x'].mean(), dataset_walking['acc_phone_y'].mean(), dataset_walking['acc_phone_z'].mean())
print(dataset_walking['acc_phone_x'].std(), dataset_walking['acc_phone_y'].std(), dataset_walking['acc_phone_z'].std())
